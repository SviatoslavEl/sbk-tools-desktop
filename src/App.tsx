...
function App() {
  ...
  return <div className={`app-shell ${collapsed ? "sidebar-collapsed" : ""}`}>
    <aside className="sidebar" aria-label="Инструменты">
      ...
      <nav className="tool-nav">{tools.map((tool) => <button key={tool.id} aria-label={tool.label} title={tool.label} className={activeTool === tool.id ? "active" : ""} onClick={() => selectTool(tool.id)} type="button"><span className="nav-icon" aria-hidden="true">{tool.icon}</span><span className="nav-label">{tool.label}</span></button>)}</nav>
      <nav className="settings-nav"><button aria-label="Архив" title="Архив" className={activeTool === "archive" ? "active" : ""} onClick={() => selectTool("archive")} type="button"><span className="nav-icon" aria-hidden="true">⌫</span><span className="nav-label">Архив</span></button><button aria-label="Настройки" title="Настройки" className={activeTool === "settings" ? "active" : ""} onClick={() => selectTool("settings")} type="button"><span className="nav-icon" aria-hidden="true">⚙</span><span className="nav-label">Настройки</span></button><button aria-label="О программе" title="О программе" className={activeTool === "about" ? "active" : ""} onClick={() => selectTool("about")} type="button"><span className="nav-icon" aria-hidden="true">i</span><span className="nav-label">О программе</span></button></nav>
    </aside>
